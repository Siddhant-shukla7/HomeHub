...
function App() {
  const stripePromise = loadStripe("pk_test_51Ot0HnSH9Gp2s4h2KO5cCGyWpmL3rdD2Rnl2yD2a23Y5TKoFTGwJVXXO70CtxHSt7gfM7JR7Wy50adQ5vt5TIORy00tXGDDtEg")
  ...
  const router = createBrowserRouter(
    ...
    createRoutesFromElements(
      //defines a route component that matches all the paths "/" and renders to the main component.
      ...
      <Route element={<PropertyDetails />} id='PropertyDetails' 
  ...
  return ( 
  <div className="App">
    {/* this ensures that the routing functions ia available throughout the application */}
